...
namespace Bulla\database;

use \Bulla\database\Log;
use \Exception;
use \PDO;
use \PDOException;
...
class DB
{
     ...
     */
    private function Connect($hostname, $database, $username, $password, $port = 3306)
    {
        global $settings;
        ...
        try
        {
            ...
            # Set fecth mode to fetch array assoc
